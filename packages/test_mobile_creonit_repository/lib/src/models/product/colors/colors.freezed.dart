...
class _$ColorsTearOff {
  ...
  _Colors call({required String title, required String code}) {
    return _Colors(
      title: title,
      code: code,
    );
...
class _$_Colors implements _Colors {
  _$_Colors({required this.title, required this.code});
  ...
  @override
  String toString() {
    return 'Colors(title: $title, code: $code)';
  }
...
abstract class _Colors implements Colors {
  factory _Colors({required String title, required String code}) = _$_Colors;
